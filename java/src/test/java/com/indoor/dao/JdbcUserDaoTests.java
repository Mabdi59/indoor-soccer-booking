...
public class JdbcUserDaoTests extends BaseDaoTests {
    protected static final User USER_1 = new User(1, "user1", "user1", "user1@example.com", "123-456-7890", "ROLE_USER", "ROLE_USER");
    protected static final User USER_2 = new User(2, "user2", "user2", "user2@example.com", "123-456-7891", "ROLE_USER", "ROLE_USER");
    private static final User USER_3 = new User(3, "user3", "user3", "user3@example.com", "123-456-7892", "ROLE_USER", "ROLE_USER");
    ...
    public void createUser_with_null_username() {
        ...
        registerUserDto.setPhone(USER_3.getPhone());
